module Jekyll
  ...
  class NoteTag < Liquid::Tag
    ...
    def render(context)
      detail = context['site']['data']['notes'][@note]
      marker = %{<sup><a id='#{@note}' class='tooled' href='#' onclick='return false;'><svg version="1.1" id="Info_circled" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      	 y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><path d="M10,0.4c-5.303,0-9.601,4.298-9.601,9.6c0,5.303,4.298,9.601,9.601,9.601c5.301,0,9.6-4.298,9.6-9.601
      	...
      	C10.786,15.168,9.137,15.75,8.498,15.75z"/></svg></a></sup>}
      tipbox = %{<span id="#{@note}-tip" class="tooltip"><span class="inner">#{detail}</span></span>}
